...
export default function Header() {
  ...
  return (
    <header className="flex bg-black text-white justify-between text-2xl items-center px-10 py-8 phone:max-md:p-0 phone:max-md:flex-wrap">
      ...
      {(navStatus || opcoesStatus) && (
        <div onClick={fecharDialogos} className="overlay fixed top-0 left-0 w-full h-full bg-black bg-opacity-30 z-10"></div>
      )}
